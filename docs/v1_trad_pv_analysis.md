...
- PTERM ≤ 5yr: 위 상품이라도 차감 없음 (0% 차감)
- PTERM ≥ 7yr: 위 상품이면 100% 차감
- IP_P_COV의 TMRFND_CALC_TP 코드만으로는 구분 불가 (PROD_CD + PTERM 필요)
...
| SOFF_BF_TMRFND | 235 | 154 | **LA0217Y 제외 시 100%** |

SOFF_BF_TMRFND 154건 FAIL은 전부 LA0217Y (Type C, Phase 2).
